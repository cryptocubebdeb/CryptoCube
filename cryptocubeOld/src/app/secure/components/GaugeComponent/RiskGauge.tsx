/*
  This part of the project isn’t our original work, it comes from open-source code that we reused
  
  Project used: "react-gauge-component" by Antonio Lago.
  
  Source: https://github.com/antoniolago/react-gauge-component
  Github Repo: https://antoniolago.github.io/react-gauge-component/

  Modifications: integration into Next.js project (CryptoCube), and custom risk analysis logic.
*/
