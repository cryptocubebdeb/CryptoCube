...
export default function Page() {
  return (
    <div className="h-screen flex flex-col justify-center items-center space-y-6">
      ...
      <h3 className="text-xl text-center font-mono">Launching soon</h3>

      <div className="flex justify-center items-center space-x-8">
        <Link href="/auth/signin">
          <button className="bg-yellow-400 px-6 py-2 text-white rounded-md hover:bg-yellow-700 font-mono font-semibold">
            Login
          </button>
        </Link>
