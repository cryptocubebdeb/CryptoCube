...
export default function Toolbar() {
    return (
        <aside className="fixed left-6 top-[70px] h-[calc(100vh-70px)] w-16 rounded-3xl bg-[#13141a] border border-[#23252c] flex flex-col items-center justify-between py-4">
            {/* logo */}
